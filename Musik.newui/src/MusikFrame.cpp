...
{
	//-----------------------------------------------------//
	//--- grab the default size of a wxTextCtrl, then	---//
	//--- set it to the sizer for the query				---//
	//-----------------------------------------------------//
	...
	//-----------------------------------------------------//
	//--- create all the controls. just create with	a	---//
	//--- parent of the correct value, and the			---//
	//--- wxSashLayoutWindow will take care of the		---//
	//--- rest											---//
	//-----------------------------------------------------//
	m_SourcesCtrl		= new CMusikSourcesCtrl			( m_SourcesSash, -1, MUSIK_SOURCES_FILENAME );
