...
#define MUSIK_VERSION			wxT( "Musik 0.1.4 CVS" )
#define MUSIKSERV_VERSION		wxT( "MusikServ 0.1.4 CVS" )
...
enum EMUSIK_MENU_ITEMS
{
	...
	MUSIK_PLAYLIST_DISPLAY_RATING,
	MUSIK_PLAYLIST_DISPLAY_TRACK,
	MUSIK_PLAYLIST_DISPLAY_TITLE,
	MUSIK_PLAYLIST_DISPLAY_ARTIST,
	MUSIK_PLAYLIST_DISPLAY_ALBUM,
	MUSIK_PLAYLIST_DISPLAY_YEAR,
	MUSIK_PLAYLIST_DISPLAY_GENRE,
	MUSIK_PLAYLIST_DISPLAY_TIMES_PLAYED,
	MUSIK_PLAYLIST_DISPLAY_LAST_PLAYED,
	MUSIK_PLAYLIST_DISPLAY_TIME,
	MUSIK_PLAYLIST_DISPLAY_BITRATE,
	MUSIK_PLAYLIST_DISPLAY_FILENAME,
